...
$lang['service_and_provider'] = 'Support Center and Instructor';
$lang['select_service'] = 'Select a support center';
$lang['select_provider'] = 'Select Instructor';
...
$lang['customer_information'] = 'Student Information';
...
$lang['update'] = 'Update';
$lang['cancel_appointment_hint'] = 'Press the "Cancel" button to remove the appointment from the department schedule.';
$lang['cancel'] = 'Cancel';
...
$lang['service'] = 'Support Center';
$lang['provider'] = 'Instructor';
...
$lang['manage_appointment_record_hint'] = 'Manage all the appointment records of the available instructors and support centers.';
$lang['select_filter_item_hint'] = 'Select a instructor or a support center and view the appointments on the calendar.';
...
$lang['manage_services_hint'] = 'Manage the available support centers and categories of the system.';
$lang['manage_users_hint'] = 'Manage the backend users (admins, instructors, coordinators).';
...
$lang['provider_saved'] = 'Instructor saved successfully.';
$lang['secretary_saved'] = 'Coordinator saved successfully.';
$lang['admin_deleted'] = 'Admin deleted successfully.';
$lang['provider_deleted'] = 'Instructor deleted successfully.';
$lang['secretary_deleted'] = 'Coordinator deleted successfully.';
$lang['service_saved'] = 'Support center saved successfully.';
$lang['service_category_saved'] = 'Support center category saved successfully.';
$lang['service_deleted'] = 'Support center deleted successfully.';
$lang['service_category_deleted'] = 'Support center category deleted successfully.';
...
$lang['sunday'] = 'Sunday';
$lang['breaks'] = 'Breaks';
$lang['add_breaks_during_each_day'] = 'Add the working breaks during each day. During breaks the instructor will not accept any appointments.';
$lang['day'] = 'Day';
$lang['days'] = 'Days';
$lang['actions'] = 'Actions';
$lang['reset_working_plan_hint'] = 'Reset the working plan back to the default values.';
$lang['company_name'] = 'Department Name';
$lang['company_name_hint'] = 'Department name will be displayed everywhere on the system (required).';
$lang['company_email'] = 'Department Email';
$lang['company_email_hint'] = 'This will be the department email address. It will be used as the sender and the reply address of the system emails (required).';
$lang['company_link'] = 'Department Link';
$lang['company_link_hint'] = 'Department link should point to the official website of the department (required).';
...
$lang['edit_breaks_hint'] = 'Add the working breaks during each day. These breaks will be applied for all new instructors.';
$lang['book_advance_timeout'] = 'Book Advance Timeout';
$lang['book_advance_timeout_hint'] = 'Define the timeout (in minutes) before the students can book or re-arrange appointments with the department.';
$lang['timeout_minutes'] = 'Timeout (Minutes)';
$lang['about_app_info'] = 'Easy!Appointments is a highly customizable web application that allows your students to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other Support centers.';
...
$lang['delete_service'] = 'Delete Support center';
$lang['delete_category'] = 'Delete Support center Category';
$lang['delete_provider'] = 'Delete Instructor';
...
$lang['require_captcha_hint'] = 'When enabled, the students will have to type a random generated CAPTCHA string before booking/updating an appointment.';
$lang['captcha_is_wrong'] = 'CAPTCHA verification failed, please try again.';
$lang['any_provider'] = 'Any Instructor';
...
$lang['customer_notifications'] = 'Student Notifications';
$lang['customer_notifications_hint'] = 'Defines whether the student will receive email notifications whenever there is a schedule change on one of his appointments.';
...
$lang['overwrite_existing_working_plans'] = 'This will overwrite the existing instructor working plans, are you sure that you want to continue?';
$lang['working_plans_got_updated'] = 'All the working plans got updated.';
$lang['apply_to_all_providers'] = 'Apply To All Instructors';
$lang['display_any_provider'] = 'Display Any Instructor Option';
$lang['display_any_provider_hint'] = 'The booking page will get an additional option that allows students to book without specifying an instructor.';
